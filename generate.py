...
def simple_diagram(graph, graph_name, max_layout_retry=10, save_diagram=True, save_dir='files', hide_dummy=True, **kwargs):
    print('%s: %s' % (graph_name, str(graph)))
    plot_graph(graph, save_figure=save_diagram, save_path=os.path.join(save_dir, 'raw.pdf'), hide_dummy=False)
    ...
    plot_graph(cr_graph, save_figure=save_diagram, save_path=cross_figure_path, hide_dummy=hide_dummy)
    ...
    plot_graph(opt_graph, save_figure=save_diagram, save_path=layout_figure_path, hide_dummy=hide_dummy)
